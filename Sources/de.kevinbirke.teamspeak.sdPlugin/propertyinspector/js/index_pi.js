...
$SD.on('connected', (jsn) => {
    ...
    var actionInfo = $SD.actionInfo;
    var applicationInfo = $SD.applicationInfo;
    ...
    if (action == "de.kevinbirke.teamspeak.microphone") {
        // Add microphone_mode
        var item = "<div class='sdpi-item' id='select_single'> \
            <div class='sdpi-item-label'>Mode</div> \
            <select class='sdpi-item-value select' id='microphone_mode'> \
                <option value='toggle'>Toggle</option> \
                <option value='mute'>Mute</option> \
                <option value='unmute'>Unmute</option> \
            </select> \
        </div>";
        document.getElementById('placeholder').innerHTML = item;
    } else if (action == "de.kevinbirke.teamspeak.sound") {
        // Add sound_mode
        var item = "<div class='sdpi-item' id='select_single'> \
            <div class='sdpi-item-label'>Mode</div> \
            <select class='sdpi-item-value select' id='sound_mode'> \
                <option value='toggle'>Toggle</option> \
                <option value='mute'>Mute</option> \
                <option value='unmute'>Unmute</option> \
            </select> \
        ...
        document.getElementById('placeholder').innerHTML = item;
    } else if (action == "de.kevinbirke.teamspeak.afk") {
        // Add afk_mode
        var item = "<div class='sdpi-item' id='select_single'> \
            <div class='sdpi-item-label'>Mode</div> \
            <select class='sdpi-item-value select' id='afk_mode'> \
                <option value='toggle'>Toggle</option> \
